...
struct CloudModel: Identifiable, Cloud {
    ...
    init(id: UUID, name: String, abbreviation: String, images: [String], aboutInfo: String, altitude: CloudAltitude, precipitation: String, cloudsSimilarTo: [UUID : String], cloudsToLookFor: [CloudModel], displayImage: String, cloudOfTheDayImage: String) {
        self.id = id
        self.name = name
...
struct ScanAttemptModel: Identifiable, Cloud {
    ...
    var displayImage: String
    var name: String {
        return cloudIdentified.name
    }
    var abbreviation: String {
        return cloudIdentified.abbreviation
    }
    
    
    init(id: UUID, imageName: String, dateTime: Date, cloudIdentified: CloudModel, displayImage: String) {
        self.id = id
